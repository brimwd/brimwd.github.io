...
WelcomeState.prototype.draw = function(game, dt, ctx) {
    ...
    ctx.font="30px ninebit";
    ctx.fillStyle = '#ffffff';
    ctx.textBaseline="center";
    ctx.textAlign="center";
    ctx.fillText("Space Invaders", game.width / 2, game.height/2 - 40);
    ctx.font="16px ninebit";
...
PlayState.prototype.update = function(game, dt, ctx) {
    ...
    for(var i=0; i<this.bombs.length; i++) {
        var bomb = this.bombs[i];
        if(bomb.x >= (this.ship.x - (this.ship.width/2)+2) && bomb.x <= (this.ship.x + (this.ship.width/2)+2) &&
                bomb.y >= (this.ship.y - this.ship.height/3) && bomb.y <= (this.ship.y + this.ship.height/3)) {
            this.bombs.splice(i--, 1);
            game.lives--;
...
PlayState.prototype.draw = function(game, dt, ctx) {
    ...
    //  Draw ship.
    ctx.fillStyle = '#D33DEF';
    ctx.font="32px ninebit";
...
LevelIntroState.prototype.draw = function(game, dt, ctx) {
    ...
    ctx.font="36px ninebit";
    ctx.fillStyle = '#ffffff';
    ctx.textBaseline="middle";
    ctx.textAlign="center";
    ctx.fillText("Level " + this.level, game.width / 2, game.height/2);
    ctx.font="24px ninebit";
